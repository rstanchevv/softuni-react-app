...
export const HeroSectionAuthenticated = () => {
  return (
    <div className="container-fluid px-4 py-5 my-5 text-center">
      ...
      <div className="lc-block col-lg-6 mx-auto mb-4">
        <div editable="rich">
          <p className="lead ">
            We are glad that you part of our community. What are you waiting for? Go to Offers!
          </p>
        </div>
      </div>
      ...
      <div className="lc-block d-grid gap-2 d-sm-flex justify-content-sm-center">
        {" "}
        <Link className="btn btn-primary btn-lg px-4 gap-3" href="#" role="button" to="/catalog">
          Offers
        </Link>
      </div>
    </div>
